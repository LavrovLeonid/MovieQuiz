...
final class MovieQuizViewController: UIViewController {
    ...
    private func show(quiz step: QuizStepViewModel) {
        ...
        // сбрасываем рамку у следующего
        imageView.layer.borderWidth = 0
        
        // дизейблим кнопки до момента показа следующего вопроса
    ...
    private func showAnswerResult(isCorrect: Bool) {
        ...
        imageView.layer.borderColor = isCorrect ? UIColor.ypGreen.cgColor : UIColor.ypRed.cgColor // утсанавливаем цвет рамки в зависимости от ответа
